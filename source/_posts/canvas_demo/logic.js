var animate = (function(w){
	...
	ap.init = function(){
		...
		osCtx.fillText("魔镜魔镜" , this.osCanvas.width/2 , this.osCanvas.height/2-40);
		osCtx.fillText("全世界谁最美丽" , this.osCanvas.width/2 , this.osCanvas.height/2+50);
	...
	function getLogoData(){
		...
		osCtx.fillText("OMG" , 295 , this.osCanvas.height/2);

		osCtx.font="40px 微软雅黑,黑体 bold";
		osCtx.fillStyle="#405159";
		osCtx.fillText("当然是" , 160 , this.osCanvas.height/2);
		osCtx.fillText("刘慧颖" , 430 , this.osCanvas.height/2);
